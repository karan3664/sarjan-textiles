...
export function AdminCmsClient() {
    ...
    setCms((current) =>
      current
        ? {
            ...
            home: {
              ...current.home,
              hero: { ...current.home.hero, [key]: value },
            },
          }
        : current,
    );
  ...
  const setSettings = (
    key: keyof CmsSnapshot["siteSettings"],
    value: string | number,
  ) => {
    setCms((current) =>
      current
    ...
    <>
      ...
      <div className="wg-box mb-30" id="homepage">
        <div className="flex items-center justify-between mb-24">
          ...
          <button type="button" className="tf-button style-1" onClick={saveCms}>
            Save Homepage
          </button>
        </div>
        <div className="cols gap22">
          ...
          <fieldset>
            ...
            <input
              ...
              onChange={(event) => setHome("image", event.target.value)}
            />
          </fieldset>
        </div>
        <fieldset>
          ...
          <textarea
            value={cms.home.hero.description}
            onChange={(event) => setHome("description", event.target.value)}
          />
        </fieldset>
      </div>
        ...
        <div className="cols gap22">
          ...
          <fieldset>
            ...
            <input
              ...
              onChange={(event) =>
                setProductDraft({ ...productDraft, fabric: event.target.value })
              }
            />
          </fieldset>
          <fieldset>
          ...
          <fieldset>
            ...
            <input
              value={arrayToCsv(productDraft.colors)}
              onChange={(event) =>
                setProductDraft({
                  ...productDraft,
                  colors: csvToArray(event.target.value),
                })
              }
            />
          </fieldset>
          <fieldset>
            ...
            <input
              value={arrayToCsv(productDraft.sizes)}
              onChange={(event) =>
                setProductDraft({
                  ...productDraft,
                  sizes: csvToArray(event.target.value),
                })
              }
            />
          </fieldset>
          <fieldset>
            ...
            <input
              value={arrayToCsv(productDraft.images)}
              onChange={(event) =>
                setProductDraft({
                  ...productDraft,
                  images: csvToArray(event.target.value),
                })
              }
            />
          </fieldset>
      ...
      <div className="wg-box mb-30" id="blogs">
        ...
        <div className="cols gap22">
          <fieldset>
            ...
            >
              {cms.blogs.map((blog) => (
                <option value={blog.slug} key={blog.slug}>
                  {blog.title}
                </option>
              ))}
            </select>
          ...
          <fieldset>
            ...
            <input
              ...
              onChange={(event) =>
                setBlogDraft({ ...blogDraft, title: event.target.value })
              }
            />
          </fieldset>
          <fieldset>
            ...
            <input
              ...
              onChange={(event) =>
                setBlogDraft({ ...blogDraft, slug: event.target.value })
              }
            />
          </fieldset>
          <fieldset>
            ...
            <input
              ...
              onChange={(event) =>
                setBlogDraft({ ...blogDraft, date: event.target.value })
              }
            />
          </fieldset>
          <fieldset>
            ...
            <input
              ...
              onChange={(event) =>
                setBlogDraft({ ...blogDraft, image: event.target.value })
              }
            />
          </fieldset>
          <fieldset>
            ...
            <input
              ...
              onChange={(event) =>
                setBlogDraft({ ...blogDraft, excerpt: event.target.value })
              }
            />
          </fieldset>
        </div>
        <fieldset>
          ...
          <textarea
            ...
            onChange={(event) =>
              setBlogDraft({ ...blogDraft, content: event.target.value })
            }
          />
        </fieldset>
      </div>
      ...
      <div className="wg-box" id="settings">
        ...
        <div className="cols gap22">
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.ordersEmail}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.address}
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.directionsUrl ?? ""}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.openTimeWeekday}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.openTimeSunday}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              type="number"
              value={cms.siteSettings.creditTermDays}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.footerNote}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.footerInfoHeading ?? ""}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.footerCustomerHeading ?? ""}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.footerNewsletterHeading ?? ""}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.footerNewsletterText ?? ""}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.footerCredit ?? ""}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.facebookUrl ?? ""}
              onChange={(event) =>
          ...
          <fieldset>
            ...
            <input
              value={cms.siteSettings.instagramUrl ?? ""}
              onChange={(event) =>
        ...
        >
          {saveState === "saving"
            ? "Saving..."
            : saveState === "saved"
              ? "Saved. Storefront now reads updated CMS data."
              : saveState === "error"
                ? "Save failed."
                : "Ready."}
        </div>
